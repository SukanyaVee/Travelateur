...
class UserEdit extends Component {
    ...
    edit(firstName, lastName, city, country, email, password, pic){
        var user = {firstName:firstName, lastName:lastName, city:city, country: country, email: email, password:password, pic:pic}
        ...
        return (
            <div className="user-edit-page">
                ...
                <div className="reg-container">
                    ...
                    PASSWORD <br/><input type="password"  onChange={event=>{this.setState({f: event.target.value})}}/><br/><br/>
                    PROFILE PIC<br/><input onChange={event=>{this.setState({g: event.target.value})}}/>
                    </div>
                    <br/><br/>
                    <div>
